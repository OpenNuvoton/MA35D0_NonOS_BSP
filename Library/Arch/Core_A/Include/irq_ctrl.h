...
#define IRQ_MODE_MA35D0MAIN_Pos         (4U)
#define IRQ_MODE_MA35D0MAIN_Msk         (0x01UL << IRQ_MODE_MA35D0MAIN_Pos)
#define IRQ_MODE_MA35D0MAIN_NONSECURE   (0x00UL << IRQ_MODE_MA35D0MAIN_Pos)   ///< MA35D0main: interrupt is targeting non-secure MA35D0main
#define IRQ_MODE_MA35D0MAIN_SECURE      (0x01UL << IRQ_MODE_MA35D0MAIN_Pos)   ///< MA35D0main: interrupt is targeting secure MA35D0main
...
#define IRQ_CPU_0              (0x01UL << 0)      ///< CPU: interrupt targets CPU 0
#define IRQ_CPU_1              (0x01UL << 1)      ///< CPU: interrupt targets CPU 1
...
//#define IRQ_SetTarget GIC_SetTarget
...
void IRQ_SetTarget (IRQn_Type IRQn, uint32_t cpu_target);
