/**************************************************************************//**
 * @file     vc8000_lib.h
 * @brief    VC8000 JPEG decoder library header file
 *
...
#define VC8000_ERR_DEC_INIT           -100   /*!< JPEG decoder initialization failed */
#define VC8000_ERR_TIMEOUT            -101   /*!< JPEG decode timeout */
#define VC8000_ERR_DECODE             -102   /*!< JPEG decode error */
...
/**
  * @brief    Initialize VC8000 library.
