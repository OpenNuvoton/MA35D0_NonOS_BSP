...
/**
  ...
  * SSMCC::TZC2:Ch1   PDMA0, PDMA1, PDMA2, PDMA3
  *                   SDH0, SDH1
...
void SSMCC_SetRegion0(uint32_t attrib)
{
        ...
        TZC2->REGION_ID_ACCESS_0 = attrib & 0x00010001;
}
...
void SSMCC_SetRegion(SSMCC_PARAM_T param)
{
        ...
        TZC0->REGION[param.region_no].REGION_ID_ACCESS = param.attribute & 0x00010001;         /* bit0: Non-secure */
        ...
        TZC2->REGION[param.region_no].REGION_ID_ACCESS = param.attribute & 0x00010001;         /* bit0: Non-secure */
}
