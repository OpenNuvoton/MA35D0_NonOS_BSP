...
#define SYSTEM_CLOCK	650000000U

// #define DRAM_SIZE		0x10000000   /* Define the DRAM size in external DDR case */
...
void SSMCC_SetRegion1(void)
{
	...
	param.attribute = SSMCC_SECURE_READ|SSMCC_SECURE_WRITE|SSMCC_NONSECURE_READ|SSMCC_NONSECURE_WRITE;
