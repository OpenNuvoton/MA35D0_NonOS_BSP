 ...
 * |        |          |If counter halt is enabled, all EPWM counters will keep current value until exit ICE debug mode.
 ...
 * |        |          |0 = EPWM counter disabled to load PHS value.
 * |        |          |1 = EPWM counter enabled to load PHS value.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |ECLKSRC0  |EPWM_CH01 External Clock Source Select
 * |        |          |0000 = EPWMx_CLK, x denotes 0, 1 or 2.
 * |        |          |0001 = TIMER0 overflow.
 * |        |          |0010 = TIMER1 overflow.
 * |        |          |0011 = TIMER2 overflow.
 * |        |          |0100 = TIMER3 overflow.
 * |        |          |0101 = TIMER4 overflow.
 * |        |          |0110 = TIMER5 overflow.
 * |        |          |0111 = TIMER6 overflow.
 * |        |          |1000 = TIMER7 overflow.
 * |        |          |1001 = TIMER8 overflow.
 * |        |          |1010 = TIMER9 overflow.
 * |        |          |1011 = TIMER10 overflow.
 * |        |          |1100 = TIMER11 overflow.
 * |        |          |Others = Reserved.
 * |[11:8]  |ECLKSRC2  |EPWM_CH23 External Clock Source Select
 * |        |          |0000 = EPWMx_CLK, x denotes 0, 1 or 2.
 * |        |          |0001 = TIMER0 overflow.
 * |        |          |0010 = TIMER1 overflow.
 * |        |          |0011 = TIMER2 overflow.
 ...
 * |        |          |1100 = TIMER11 overflow.
 * |        |          |Others = Reserved.
 * |[19:16] |ECLKSRC4  |EPWM_CH45 External Clock Source Select
 * |        |          |0000 = EPWMx_CLK, x denotes 0, 1 or 2.
 * |        |          |0001 = TIMER0 overflow.
 * |        |          |0010 = TIMER1 overflow.
 * |        |          |0011 = TIMER2 overflow.
 ...
 * |        |          |1100 = TIMER11 overflow.
 * |        |          |Others = Reserved.
 * @var EPWM_T::CLKPSC0_1
 * Offset: 0x14  EPWM Clock Prescale Register 0/1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var EPWM_T::CLKPSC2_3
 * Offset: 0x18  EPWM Clock Prescale Register 2/3
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |CLKPSC    |EPWM Counter Clock Prescale
 ...
 * |        |          |Each EPWM pair share one EPWM counter clock prescaler
 * |        |          |The clock of EPWM counter is divided by (CLKPSC+ 1)
 * @var EPWM_T::CLKPSC4_5
 * Offset: 0x1C  EPWM Clock Prescale Register 4/5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |CLKPSC    |EPWM Counter Clock Prescale
 ...
 * |        |          |This bit is software write, hardware clear when current EPWM period ended.
 * |        |          |Write Operation:
 * |        |          |0 = No effect.
 ...
 * |        |          |Note: This bit is only used in window loading mode, WINLDENn(EPWM_CTL0[13:8]) = 1.
 ...
 * |        |          |Note: This bit is only used in window loading mode, WINLDENn(EPWM_CTL0[13:8]) = 1.
 * @var EPWM_T::PERIOD0
 * Offset: 0x30  EPWM Period Register 0
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var EPWM_T::PERIOD1
 * Offset: 0x34  EPWM Period Register 1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PERIOD    |EPWM Period Register
 ...
 * |        |          |EPWM period time = 2 * PERIOD * (CLKPSC+1) * EPWM_CLK.
 * @var EPWM_T::PERIOD2
 * Offset: 0x38  EPWM Period Register 2
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PERIOD    |EPWM Period Register
 ...
 * |        |          |EPWM period time = 2 * PERIOD * (CLKPSC+1) * EPWM_CLK.
 * @var EPWM_T::PERIOD3
 * Offset: 0x3C  EPWM Period Register 3
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PERIOD    |EPWM Period Register
 ...
 * |        |          |EPWM period time = 2 * PERIOD * (CLKPSC+1) * EPWM_CLK.
 * @var EPWM_T::PERIOD4
 * Offset: 0x40  EPWM Period Register 4
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PERIOD    |EPWM Period Register
 ...
 * |        |          |EPWM period time = 2 * PERIOD * (CLKPSC+1) * EPWM_CLK.
 * @var EPWM_T::PERIOD5
 * Offset: 0x44  EPWM Period Register 5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PERIOD    |EPWM Period Register
 ...
 * @var EPWM_T::CMPDAT1
 * Offset: 0x54  EPWM Comparator Register 1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMP       |EPWM Comparator Register
 ...
 * |        |          |In complementary mode, CMPDAT0, 2, 4 is denoted as the first compared point, and CMPDAT1, 3, 5 is denoted as the second compared point for the corresponding 3 complementary pairs EPWM_CH0 and EPWM_CH1, EPWM_CH2 and EPWM_CH3, EPWM_CH4 and EPWM_CH5.
 * @var EPWM_T::CMPDAT2
 * Offset: 0x58  EPWM Comparator Register 2
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMP       |EPWM Comparator Register
 ...
 * |        |          |In complementary mode, CMPDAT0, 2, 4 is denoted as the first compared point, and CMPDAT1, 3, 5 is denoted as the second compared point for the corresponding 3 complementary pairs EPWM_CH0 and EPWM_CH1, EPWM_CH2 and EPWM_CH3, EPWM_CH4 and EPWM_CH5.
 * @var EPWM_T::CMPDAT3
 * Offset: 0x5C  EPWM Comparator Register 3
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMP       |EPWM Comparator Register
 ...
 * |        |          |In complementary mode, CMPDAT0, 2, 4 is denoted as the first compared point, and CMPDAT1, 3, 5 is denoted as the second compared point for the corresponding 3 complementary pairs EPWM_CH0 and EPWM_CH1, EPWM_CH2 and EPWM_CH3, EPWM_CH4 and EPWM_CH5.
 * @var EPWM_T::CMPDAT4
 * Offset: 0x60  EPWM Comparator Register 4
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMP       |EPWM Comparator Register
 ...
 * |        |          |In complementary mode, CMPDAT0, 2, 4 is denoted as the first compared point, and CMPDAT1, 3, 5 is denoted as the second compared point for the corresponding 3 complementary pairs EPWM_CH0 and EPWM_CH1, EPWM_CH2 and EPWM_CH3, EPWM_CH4 and EPWM_CH5.
 * @var EPWM_T::CMPDAT5
 * Offset: 0x64  EPWM Comparator Register 5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMP       |EPWM Comparator Register
 ...
 * |        |          |In complementary mode, CMPDAT0, 2, 4 is denoted as the first compared point, and CMPDAT1, 3, 5 is denoted as the second compared point for the corresponding 3 complementary pairs EPWM_CH0 and EPWM_CH1, EPWM_CH2 and EPWM_CH3, EPWM_CH4 and EPWM_CH5.
 * @var EPWM_T::DTCTL0_1
 * Offset: 0x70  EPWM Dead-time Control Register 0/1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |DTCNT     |Dead-time Counter (Write Protect)
 * |        |          |The dead-time can be calculated from the following formula:
 * |        |          |DTCKSEL=0: Dead-time = (DTCNT[11:0]+1) * EPWM_CLK period.
 * |        |          |DTCKSEL=1: Dead-time = (DTCNT[11:0]+1) * EPWM_CLK period * (CLKPSC+1).
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register
 * |[16]    |DTEN      |Enable Dead-time Insertion for EPWM Pair (Write Protect)
 ...
 * @var EPWM_T::DTCTL2_3
 * Offset: 0x74  EPWM Dead-time Control Register 2/3
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |DTCNT     |Dead-time Counter (Write Protect)
 ...
 * |        |          |Note: This bit is write protected. Refer to REGWRPROT register.
 * @var EPWM_T::DTCTL4_5
 * Offset: 0x78  EPWM Dead-time Control Register 4/5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |DTCNT     |Dead-time Counter (Write Protect)
 ...
 * |        |          |Note: This bit is write protected. Refer to REGWRPROT register.
 * @var EPWM_T::PHS0_1
 * Offset: 0x80  EPWM Counter Phase Register 0/1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PHS       |EPWM Synchronous Start Phase Bits
 * |        |          |PHS determines the EPWM synchronous start phase value
 * |        |          |These bits are only used for synchronous function.
 * @var EPWM_T::PHS2_3
 * Offset: 0x84  EPWM Counter Phase Register 2/3
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PHS       |EPWM Synchronous Start Phase Bits
 ...
 * |        |          |These bits are only used for synchronous function.
 * @var EPWM_T::PHS4_5
 * Offset: 0x88  EPWM Counter Phase Register 4/5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PHS       |EPWM Synchronous Start Phase Bits
 ...
 * |        |          |These bits are only used for synchronous function.
 * @var EPWM_T::CNT0
 * Offset: 0x90  EPWM Counter Register 0
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var EPWM_T::CNT1
 * Offset: 0x94  EPWM Counter Register 1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CNT       |EPWM Data Register (Read Only)
 ...
 * |        |          |1 = Counter is counting up.
 * @var EPWM_T::CNT2
 * Offset: 0x98  EPWM Counter Register 2
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CNT       |EPWM Data Register (Read Only)
 ...
 * |        |          |1 = Counter is counting up.
 * @var EPWM_T::CNT3
 * Offset: 0x9C  EPWM Counter Register 3
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CNT       |EPWM Data Register (Read Only)
 ...
 * |        |          |1 = Counter is counting up.
 * @var EPWM_T::CNT4
 * Offset: 0xA0  EPWM Counter Register 4
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CNT       |EPWM Data Register (Read Only)
 ...
 * |        |          |1 = Counter is counting up.
 * @var EPWM_T::CNT5
 * Offset: 0xA4  EPWM Counter Register 5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CNT       |EPWM Data Register (Read Only)
 ...
 * |        |          |10 = EPWM zero point output High.
 * |        |          |11 = EPWM zero point output Toggle.
 * |[17:16] |PRDPCTL0  |EPWM Period Point Control
 ...
 * |[19:18] |PRDPCTL1  |EPWM Period Point Control
 * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
 * |        |          |00 = Do nothing.
 * |        |          |01 = EPWM period (center) point output Low.
 * |        |          |10 = EPWM period (center) point output High.
 * |        |          |11 = EPWM period (center) point output Toggle.
 * |        |          |Note: This bit is center point control when EPWM counter operating in up-down counter type.
 * |[21:20] |PRDPCTL2  |EPWM Period Point Control
 * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
 * |        |          |00 = Do nothing.
 * |        |          |01 = EPWM period (center) point output Low.
 * |        |          |10 = EPWM period (center) point output High.
 * |        |          |11 = EPWM period (center) point output Toggle.
 * |        |          |Note: This bit is center point control when EPWM counter operating in up-down counter type.
 * |[23:22] |PRDPCTL3  |EPWM Period Point Control
 * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
 * |        |          |00 = Do nothing.
 * |        |          |01 = EPWM period (center) point output Low.
 * |        |          |10 = EPWM period (center) point output High.
 * |        |          |11 = EPWM period (center) point output Toggle.
 * |        |          |Note: This bit is center point control when EPWM counter operating in up-down counter type.
 * |[25:24] |PRDPCTL4  |EPWM Period Point Control
 * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
 * |        |          |00 = Do nothing.
 * |        |          |01 = EPWM period (center) point output Low.
 * |        |          |10 = EPWM period (center) point output High.
 * |        |          |11 = EPWM period (center) point output Toggle.
 * |        |          |Note: This bit is center point control when EPWM counter operating in up-down counter type.
 * |[27:26] |PRDPCTL5  |EPWM Period Point Control
 * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
 * |        |          |00 = Do nothing.
 * |        |          |01 = EPWM period (center) point output Low.
 * |        |          |10 = EPWM period (center) point output High.
 ...
 * |        |          |0 = brake pin event will be detected if EPWMx BRAKE0 pin status transfer from low to high in edge-detect, or pin status is high in level-detect.
 * |        |          |1 = brake pin event will be detected if EPWMx BRAKE0 pin status transfer from high to low in edge-detect, or pin status is low in level-detect.
 ...
 * |        |          |0 = brake pin event will be detected if EPWMx BRAKE1 pin status transfer from low to high in edge-detect, or pin status is high in level-detect.
 * |        |          |1 = brake pin event will be detected if EPWMx BRAKE1 pin status transfer from high to low in edge-detect, or pin status is low in level-detect.
 * |[17:16] |BK0SRC    |Brake 0 Pin Source Select
 * |        |          |For EPWM0 setting:
 * |        |          |0 = Brake 0 pin source come from EPWM0_BRAKE0.
 * |        |          |1 = Brake 0 pin source come from EPWM1_BRAKE0.
 * |        |          |2 = Brake 0 pin source come from EPWM2_BRAKE0.
 * |        |          |For EPWM1 setting:
 * |        |          |0 = Brake 0 pin source come from EPWM1_BRAKE0.
 * |        |          |1 = Brake 0 pin source come from EPWM0_BRAKE0.
 * |        |          |2 = Brake 1 pin source come from EPWM2_BRAKE0.
 * |        |          |For EPWM2 setting:
 * |        |          |0 = Brake 0 pin source come from EPWM2_BRAKE0.
 * |        |          |1 = Brake 0 pin source come from EPWM0_BRAKE0.
 * |        |          |2 = Brake 1 pin source come from EPWM1_BRAKE0.
 * |[25:24] |BK1SRC    |Brake 1 Pin Source Select
 * |        |          |For EPWM0 setting:
 * |        |          |0 = Brake 1 pin source come from EPWM0_BRAKE1.
 * |        |          |1 = Brake 1 pin source come from EPWM1_BRAKE1.
 * |        |          |2 = Brake 1 pin source come from EPWM2_BRAKE1.
 * |        |          |For EPWM1 setting:
 * |        |          |0 = Brake 1 pin source come from EPWM1_BRAKE1.
 * |        |          |1 = Brake 1 pin source come from EPWM0_BRAKE1.
 * |        |          |2 = Brake 1 pin source come from EPWM2_BRAKE1.
 * |        |          |For EPWM2 setting:
 * |        |          |0 = Brake 1 pin source come from EPWM2_BRAKE1.
 * |        |          |1 = Brake 1 pin source come from EPWM0_BRAKE1.
 * |        |          |2 = Brake 1 pin source come from EPWM1_BRAKE1.
 * @var EPWM_T::FAILBRK
 ...
 * |[1]     |LVDBRKEN  |Low Voltage Interrupt Flag Detection Trigger EPWM Brake Function 0 Enable Bit
 * |        |          |0 = Brake Function triggered by LVD Disabled.
 * |        |          |1 = Brake Function triggered by LVD Enabled.
 ...
 * @var EPWM_T::BRKCTL0_1
 * Offset: 0xC8  EPWM Brake Edge Detect Control Register 0/1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |BRKEIF0   |EPWM Channel n Edge-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n edge-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n edge-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[1]     |BRKEIF1   |EPWM Channel n Edge-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n edge-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n edge-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[2]     |BRKEIF2   |EPWM Channel n Edge-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n edge-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n edge-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[3]     |BRKEIF3   |EPWM Channel n Edge-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n edge-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n edge-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[4]     |BRKEIF4   |EPWM Channel n Edge-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n edge-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n edge-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[5]     |BRKEIF5   |EPWM Channel n Edge-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n edge-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n edge-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[8]     |BRKLIF0   |EPWM Channel n Level-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n level-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n level-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[9]     |BRKLIF1   |EPWM Channel n Level-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n level-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n level-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[10]    |BRKLIF2   |EPWM Channel n Level-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n level-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n level-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[11]    |BRKLIF3   |EPWM Channel n Level-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n level-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n level-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[12]    |BRKLIF4   |EPWM Channel n Level-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n level-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n level-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[13]    |BRKLIF5   |EPWM Channel n Level-detect Brake Interrupt Flag (Write Protect)
 * |        |          |0 = EPWM channel n level-detect brake event do not happened.
 * |        |          |1 = When EPWM channel n level-detect brake event happened, this bit is set to 1, writing 1 to clear.
 * |        |          |Note: This bit is write protected
 * |        |          |Refer to the SYS_RLKTZS register or SYS_RLKTZNS register or SYS_RLKSUBM register.
 * |[16]    |BRKESTS0  |EPWM Channel n Edge-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n edge-detect brake state is released.
 * |        |          |1 = When EPWM channel n edge-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 ...
 * |[17]    |BRKESTS1  |EPWM Channel n Edge-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n edge-detect brake state is released.
 * |        |          |1 = When EPWM channel n edge-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When edge-detect brake interrupt flag is cleared, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[18]    |BRKESTS2  |EPWM Channel n Edge-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n edge-detect brake state is released.
 * |        |          |1 = When EPWM channel n edge-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When edge-detect brake interrupt flag is cleared, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[19]    |BRKESTS3  |EPWM Channel n Edge-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n edge-detect brake state is released.
 * |        |          |1 = When EPWM channel n edge-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When edge-detect brake interrupt flag is cleared, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[20]    |BRKESTS4  |EPWM Channel n Edge-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n edge-detect brake state is released.
 * |        |          |1 = When EPWM channel n edge-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When edge-detect brake interrupt flag is cleared, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[21]    |BRKESTS5  |EPWM Channel n Edge-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n edge-detect brake state is released.
 * |        |          |1 = When EPWM channel n edge-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When edge-detect brake interrupt flag is cleared, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[24]    |BRKLSTS0  |EPWM Channel n Level-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n level-detect brake state is released.
 * |        |          |1 = When EPWM channel n level-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When enabled brake source return to high level, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[25]    |BRKLSTS1  |EPWM Channel n Level-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n level-detect brake state is released.
 * |        |          |1 = When EPWM channel n level-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When enabled brake source return to high level, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[26]    |BRKLSTS2  |EPWM Channel n Level-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n level-detect brake state is released.
 * |        |          |1 = When EPWM channel n level-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When enabled brake source return to high level, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[27]    |BRKLSTS3  |EPWM Channel n Level-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n level-detect brake state is released.
 * |        |          |1 = When EPWM channel n level-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When enabled brake source return to high level, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[28]    |BRKLSTS4  |EPWM Channel n Level-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n level-detect brake state is released.
 * |        |          |1 = When EPWM channel n level-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When enabled brake source return to high level, EPWM will release brake state until current EPWM period finished
 * |        |          |The EPWM waveform will start output from next full EPWM period.
 * |[29]    |BRKLSTS5  |EPWM Channel n Level-detect Brake Status (Read Only)
 * |        |          |0 = EPWM channel n level-detect brake state is released.
 * |        |          |1 = When EPWM channel n level-detect brake detects a falling edge of any enabled brake source; this flag will be set to indicate the EPWM channel n at brake state.
 * |        |          |Note: This bit is read only and auto cleared by hardware
 * |        |          |When enabled brake source return to high level, EPWM will release brake state until current EPWM period finished
 ...
 * |        |          |10 = Synchronous start source come from EPWM2.
 * |        |          |11 = Reserved.
 * @var EPWM_T::SSTRG
 ...
 * |        |          |0 = EPWM_CHn Stop Mode Disable.
 * |        |          |1 = EPWM_CHn Stop Mode Enable.
 ...
 * |        |          |0 = EPWM_CHn interrupt flag accumulator Disabled.
 * |        |          |1 = EPWM_CHn interrupt flag accumulator Enabled.
 * @var EPWM_T::IFA1
 * Offset: 0x134  EPWM Interrupt Flag Accumulator Register 1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |IFACNT    |EPWM_CHn Interrupt Flag Counter
 ...
 * |        |          |1 = EPWM_CHn interrupt flag accumulator Enabled.
 * @var EPWM_T::IFA2
 * Offset: 0x138  EPWM Interrupt Flag Accumulator Register 2
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |IFACNT    |EPWM_CHn Interrupt Flag Counter
 ...
 * |        |          |1 = EPWM_CHn interrupt flag accumulator Enabled.
 * @var EPWM_T::IFA3
 * Offset: 0x13C  EPWM Interrupt Flag Accumulator Register 3
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |IFACNT    |EPWM_CHn Interrupt Flag Counter
 ...
 * |        |          |1 = EPWM_CHn interrupt flag accumulator Enabled.
 * @var EPWM_T::IFA4
 * Offset: 0x140  EPWM Interrupt Flag Accumulator Register 4
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |IFACNT    |EPWM_CHn Interrupt Flag Counter
 ...
 * |        |          |1 = EPWM_CHn interrupt flag accumulator Enabled.
 * @var EPWM_T::IFA5
 * Offset: 0x144  EPWM Interrupt Flag Accumulator Register 5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |IFACNT    |EPWM_CHn Interrupt Flag Counter
 ...
 * |        |          |Flag is set by hardware when condition matches IFASEL in EPWM_IFAn register, software can clear this bit by writing 1 to it.
 ...
 * |        |          |0 = Fault detect function Disable.
 * |        |          |1 = Fault detect function Enable.
 ...
 * |        |          |0 = EPWM detect fault and output Enable.
 * |        |          |1 = EPWM detect fault and output Disable.
 ...
 * |        |          |0 = EPWMx_CLK, x denotes 0, 1or 2.
 * |        |          |1 = EPWMx_CLK divide by prescaler, x denotes 0, 1 or 2.
 ...
 * |        |          |Note:
 * |        |          |CLKPSC (EPWM_CLKPSC) is 0:
 * |        |          |TRMSKCNT >= DGSMPCYC + 2.
 * |        |          |FDCKS is 1 and CLKPSC (EPWM_CLKPSC) is 1:
 * |        |          |TRMSKCNT >= DGSMPCYC + 1.
 * |        |          |FDCKS is 1 and CLKPSC (EPWM_CLKPSC) is 2:
 * |        |          |TRMSKCNT >= DGSMPCYC.
 ...
 * |        |          |0 = Fault detect deglitch function Disable.
 * |        |          |1 = Fault detect deglitch function Enable.
 * @var EPWM_T::FDCTL1
 ...
 * |        |          |Note 2: This bit is cleared by writing 1 to it.
 * @var EPWM_T::PBUF0
 * Offset: 0x304  EPWM PERIOD0 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var EPWM_T::PBUF1
 * Offset: 0x308  EPWM PERIOD1 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PBUF      |EPWM Period Register Buffer (Read Only)
 * |        |          |Used as PERIOD active register.
 * @var EPWM_T::PBUF2
 * Offset: 0x30C  EPWM PERIOD2 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PBUF      |EPWM Period Register Buffer (Read Only)
 * |        |          |Used as PERIOD active register.
 * @var EPWM_T::PBUF3
 * Offset: 0x310  EPWM PERIOD3 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PBUF      |EPWM Period Register Buffer (Read Only)
 * |        |          |Used as PERIOD active register.
 * @var EPWM_T::PBUF4
 * Offset: 0x314  EPWM PERIOD4 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PBUF      |EPWM Period Register Buffer (Read Only)
 * |        |          |Used as PERIOD active register.
 * @var EPWM_T::PBUF5
 * Offset: 0x318  EPWM PERIOD5 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |PBUF      |EPWM Period Register Buffer (Read Only)
 * |        |          |Used as PERIOD active register.
 * @var EPWM_T::CMPBUF0
 * Offset: 0x31C  EPWM CMPDAT0 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var EPWM_T::CMPBUF1
 * Offset: 0x320  EPWM CMPDAT1 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMPBUF    |EPWM Comparator Register Buffer (Read Only)
 * |        |          |Used as CMP active register.
 * @var EPWM_T::CMPBUF2
 * Offset: 0x324  EPWM CMPDAT2 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMPBUF    |EPWM Comparator Register Buffer (Read Only)
 * |        |          |Used as CMP active register.
 * @var EPWM_T::CMPBUF3
 * Offset: 0x328  EPWM CMPDAT3 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMPBUF    |EPWM Comparator Register Buffer (Read Only)
 * |        |          |Used as CMP active register.
 * @var EPWM_T::CMPBUF4
 * Offset: 0x32C  EPWM CMPDAT4 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMPBUF    |EPWM Comparator Register Buffer (Read Only)
 * |        |          |Used as CMP active register.
 * @var EPWM_T::CMPBUF5
 * Offset: 0x330  EPWM CMPDAT5 Buffer
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |CMPBUF    |EPWM Comparator Register Buffer (Read Only)
...
#define EPWM_CLKSRC_ECLKSRC0_Msk         (0xful << EPWM_CLKSRC_ECLKSRC0_Pos)               /*!< EPWM_T::CLKSRC: ECLKSRC0 Mask          */

#define EPWM_CLKSRC_ECLKSRC2_Pos         (8)                                               /*!< EPWM_T::CLKSRC: ECLKSRC2 Position      */
#define EPWM_CLKSRC_ECLKSRC2_Msk         (0xful << EPWM_CLKSRC_ECLKSRC2_Pos)               /*!< EPWM_T::CLKSRC: ECLKSRC2 Mask          */

#define EPWM_CLKSRC_ECLKSRC4_Pos         (16)                                              /*!< EPWM_T::CLKSRC: ECLKSRC4 Position      */
#define EPWM_CLKSRC_ECLKSRC4_Msk         (0xful << EPWM_CLKSRC_ECLKSRC4_Pos)               /*!< EPWM_T::CLKSRC: ECLKSRC4 Mask          */
...
#define EPWM_BNF_BK0SRC_Msk              (0x3ul << EPWM_BNF_BK0SRC_Pos)                    /*!< EPWM_T::BNF: BK0SRC Mask               */

#define EPWM_BNF_BK1SRC_Pos              (24)                                              /*!< EPWM_T::BNF: BK1SRC Position           */
#define EPWM_BNF_BK1SRC_Msk              (0x3ul << EPWM_BNF_BK1SRC_Pos)                    /*!< EPWM_T::BNF: BK1SRC Mask               */
...
#define EPWM_FAILBRK_LVDBRKEN_Pos        (1)                                               /*!< EPWM_T::FAILBRK: LVDBRKEN Position     */
#define EPWM_FAILBRK_LVDBRKEN_Msk        (0x1ul << EPWM_FAILBRK_LVDBRKEN_Pos)              /*!< EPWM_T::FAILBRK: LVDBRKEN Mask         */
...
#define EPWM_FDIEN_FDIENn_Pos            (0)                                               /*!< EPWM_T::FDIEN: FDIENn Position         */
#define EPWM_FDIEN_FDIENn_Msk            (0x1ul << EPWM_FDIEN_FDIENn_Pos)                  /*!< EPWM_T::FDIEN: FDIENn Mask             */

#define EPWM_FDSTS_FDIFn_Pos             (0)                                               /*!< EPWM_T::FDSTS: FDIFn Position          */
#define EPWM_FDSTS_FDIFn_Msk             (0x3ful << EPWM_FDSTS_FDIFn_Pos)                  /*!< EPWM_T::FDSTS: FDIFn Mask              */
