 /**************************************************************************//**
 * @file     MA35D0.h
 * @brief    Nuvoton ARMv8-based MA35D0 Peripheral Access Layer Header File
 *
...
/**
  \mainpage NuMicro MA35D0 Driver Reference Guide
  *
  * <b>Introduction</b>
  *
  * This user manual describes the usage of MA35D0 device driver
  *
  * <b>Disclaimer</b>
  *
...
/******  Platform Exceptions Numbers ***************************************************/
      ...
      WDT0_IRQn         =   39,         /*!< WatchMA35D0g timer 0 Interrupt             */
	  WWDT0_IRQn        =   40,         /*!< WinMA35D0w WatchMA35D0g timer 0 Interrupt  */
      ...
      WDT1_IRQn         =   75,         /*!< WatchMA35D0g timer 1 Interrupt             */
      WWDT1_IRQn        =   76,         /*!< WinMA35D0w WatchMA35D0g timer 1 Interrupt  */
...
#define EMAC0_BASE              (0x40120000UL)
#define EMAC1_BASE              (0x40130000UL)
...
#define CRPT                    ((CRPT_T *)  CRYPTO_BASE)
#define TRNG                    ((TRNG_T *)  TRNG_BASE)
#define KS                      ((KS_T *)    KS_BASE)
#define NS_KS                   ((KS_T *)    (KS_BASE + 0x800))
...
#include "system_ma35d0.h"	/* System include file							*/
#include <stdint.h>
