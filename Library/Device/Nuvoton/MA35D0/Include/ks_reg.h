 ...
 */
	...
	__IO uint32_t REMAIN;                /*!< [0x000c] Key Store Remaining Space Register                               */
	__IO uint32_t SCMBKEY[4];            /*!< [0x0010 - 0x001C] Key Store Scramble Key Register                         */
	__IO uint32_t KEY[8];                /*!< [0x0020-0x003c] Key Store Entry Key Word 0 Register                       */
	__IO uint32_t OTPSTS;                /*!< [0x0040] Key Store OTP Keys Status Register                               */
	__IO uint32_t REMKCNT;               /*!< [0x0044] Key Store Remaining Key Count Register                           */
} KS_T;
...
#define KS_METADATA_OWNER_Pos            (16)                                              /*!< KS_T::METADATA: TYPE Position          */
#define KS_METADATA_OWNER_Msk            (0x7ul << KS_METADATA_OWNER_Pos)                  /*!< KS_T::METADATA: TYPE Mask              */
...
#define KS_STS_RAMINV_Pos                (8)                                               /*!< KS_T::STS: Reversed Position           */
#define KS_STS_RAMINV_Msk                (0xfffffful << KS_STS_RAMINV_Pos)                 /*!< KS_T::STS: Reversed Mask               */
...
#define KS_OTPSTS_KEY0_Pos               (0)                                               /*!< KS_T::KEY0: KEY Position               */
#define KS_OTPSTS_KEY0_Msk               (0xfffffffful << KS_OTPSTS_KEY0_Pos)              /*!< KS_T::KEY0: KEY Mask                   */

#define KS_OTPSTS_KEY1_Pos               (1)                                               /*!< KS_T::KEY0: KEY Position               */
#define KS_OTPSTS_KEY1_Msk               (0xfffffffful << KS_OTPSTS_KEY1_Pos)              /*!< KS_T::KEY0: KEY Mask                   */

#define KS_OTPSTS_KEY2_Pos               (2)                                               /*!< KS_T::KEY0: KEY Position               */
#define KS_OTPSTS_KEY2_Msk               (0xfffffffful << KS_OTPSTS_KEY2_Pos)              /*!< KS_T::KEY0: KEY Mask                   */

#define KS_OTPSTS_KEY3_Pos               (3)                                               /*!< KS_T::KEY0: KEY Position               */
#define KS_OTPSTS_KEY3_Msk               (0xfffffffful << KS_OTPSTS_KEY3_Pos)              /*!< KS_T::KEY0: KEY Mask                   */

#define KS_OTPSTS_KEY4_Pos               (4)                                               /*!< KS_T::KEY0: KEY Position               */
#define KS_OTPSTS_KEY4_Msk               (0xfffffffful << KS_OTPSTS_KEY4_Pos)              /*!< KS_T::KEY0: KEY Mask                   */
