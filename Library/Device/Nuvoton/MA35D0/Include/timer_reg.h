 ...
 * |        |          |The Timer0/2/4/6/8/10 will be in event counter mode and counting with external clock source or event
 * |        |          |Also, Timer1/3/5/7/9/11 will be in trigger-counting mode of capture function.
 * |        |          |0 = Inter-Timer Trigger Capture mode Disabled.
 * |        |          |1 = Inter-Timer Trigger Capture mode Enabled.
 * |        |          |Note: For Timer1/3/5/7/9/11, this bit is ignored and the read back value is always 0.
 ...
 * |        |          |0 = Capture Function source is from TMx_EXT (x= 0~11) pin.
 * |        |          |1 = Capture Function source is from internal clock source (HIRC 12M, LIRC) or external clock (HXT, LXT).
 * |        |          |Note: When CAPSRC = 1, user can set ICAPSSEL (TIMERx_EXTCTL[10:8]) to decide which clock is as timer capture source.
 ...
 * |        |          |This bit indicates the detection phase of external counting pin TMx (x= 0~11).
 ...
 * |        |          |0 =TMx_EXT (x= 0~11) pin Disabled.
 * |        |          |1 =TMx_EXT (x= 0~11) pin Enabled.
 * |[4]     |CAPFUNCS  |Capture Function Selection
 * |        |          |0 = External Capture Mode Enabled.
 * |        |          |1 = External Reset Mode Enabled.
 * |        |          |Note 1: When CAPFUNCS is 0, transition on TMx_EXT (x= 0~11) pin is using to save current 24-bit timer counter value (CNT value) to CAPDAT field.
 * |        |          |Note 2: When CAPFUNCS is 1, transition on TMx_EXT (x= 0~11) pin is using to save current 24-bit timer counter value (CNT value) to CAPDAT field then CNT value will be reset immediately.
 * |[5]     |CAPIEN    |Timer External Capture Interrupt Enable Bit
 * |        |          |0 = TMx_EXT (x= 0~11) pin detection Interrupt Disabled.
 * |        |          |1 = TMx_EXT (x= 0~11) pin detection Interrupt Enabled.
 ...
 * |        |          |0 = TMx_EXT (x= 0~11) pin de-bounce Disabled.
 * |        |          |1 = TMx_EXT (x= 0~11) pin de-bounce Enabled.
 ...
 * |        |          |0 = TMx (x= 0~11) pin de-bounce Disabled.
 * |        |          |1 = TMx (x= 0~11) pin de-bounce Enabled.
 * |        |          |Note: If this bit is enabled, the edge detection of TMx pin is detected with de-bounce circuit.
 * |[10:8]  |ICAPSSEL  |Internal Capture Source Selection
 ...
 * |        |          |000 = Capture event occurred when detect falling edge transfer on TMx_EXT (x= 0~11) pin.
 * |        |          |001 = Capture event occurred when detect rising edge transfer on TMx_EXT (x= 0~11) pin.
 * |        |          |010 = Capture event occurred when detect both falling and rising edge transfer on TMx_EXT (x= 0~11) pin, and first capture event occurred at falling edge transfer.
 * |        |          |011 = Capture event occurred when detect both rising and falling edge transfer on TMx_EXT (x= 0~11) pin, and first capture event occurred at rising edge transfer.
 * |        |          |110 = First capture event occurred at falling edge, follows capture events are at rising edge transfer on TMx_EXT (x= 0~11) pin.
 * |        |          |111 = First capture event occurred at rising edge, follows capture events are at falling edge transfer on TMx_EXT (x= 0~11) pin.
 * |        |          |100, 101 = Reserved.
 * |[16]    |ECNTSSEL  |Event Counter Source Selection to Trigger Event Counter Function
 * |        |          |0 = Event Counter input source is from TMx (x= 0~11) pin.
 * |[31:28] |CAPSDIV   |Timer Capture Source Divider
 * |        |          |This bits indicate the divide scale for capture source.
 ...
 * |        |          |1001~1111 = Reserved.
 * |        |          |Note: Sets ICAPSSEL (TIMERx_EXTCTL[10:8]) and CAPSRC (TIMERx_CTL[22]) to select capture source.
 * @var TIMER_T::EINTSTS
 ...
 * |        |          |0 = TMx_EXT (x= 0~11) pin interrupt did not occur.
 * |        |          |1 = TMx_EXT (x= 0~11) pin interrupt occurred.
 * |        |          |Note 1: This bit is cleared by writing 1 to it.
 * |        |          |Note 2: When CAPEN (TIMERx_EXTCTL[3]) bit is set, CAPFUNCS (TIMERx_EXTCTL[4]) bit is 0, and a transition on TMx_EXT (x= 0~11) pin matched the CAPEDGE (TIMERx_EXTCTL[2:1]) setting, this bit will set to 1 by hardware.
 ...
 * |        |          |0 = Time-out interrupt signal is used to internal trigger EPWM, BPWM, PDMA and ADC.
 * |        |          |1 = Capture interrupt signal is used to internal trigger EPWM, BPWM, PDMA and ADC.
 ...
 * |        |          |Note: This bit is write protected. Refer to SYS_RLKTZS or SYS_RLKTZND or SYS_RLKSUBM register.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |CLKSRC    |PWM Counter Clock Source Select
 * |        |          |The PWM counter clock source can be selected from TMRx_CLK or internal timer time-out or capture event.
 * |        |          |0000 = TMRx_CLK.
 * |        |          |0001 = Internal TIMER0 time-out or capture event.
 * |        |          |0010 = Internal TIMER1 time-out or capture event.
 * |        |          |0011 = Internal TIMER2 time-out or capture event.
 * |        |          |0100 = Internal TIMER3 time-out or capture event.
 * |        |          |0101 = Internal TIMER4 time-out or capture event.
 * |        |          |0110 = Internal TIMER5 time-out or capture event.
 * |        |          |0111 = Internal TIMER6 time-out or capture event.
 * |        |          |1000 = Internal TIMER7 time-out or capture event.
 * |        |          |1001 = Internal TIMER8 time-out or capture event.
 * |        |          |1010 = Internal TIMER9 time-out or capture event.
 * |        |          |1011 = Internal TIMER10 time-out or capture event.
 * |        |          |1100 = Internal TIMER11 time-out or capture event.
 * |        |          |Others = Reserved.
 ...
 * |        |          |PWM CMP is used to compare with PWM CNT to generate PWM output waveform, interrupt events and trigger ADC to start conversion.
 ...
 * |[18:16] |BKPINSRC  |Brake Pin Source Select
 * |        |          |000 = Brake pin source comes from PWM0_BRAKE0 pin.
 * |        |          |001 = Brake pin source comes from PWM0_BRAKE1 pin.
 * |        |          |010 = Brake pin source comes from PWM1_BRAKE0 pin.
 * |        |          |011 = Brake pin source comes from PWM1_BRAKE1 pin.
 * |        |          |100 = Brake pin source comes from PWM2_BRAKE0 pin.
 * |        |          |101 = Brake pin source comes from PWM2_BRAKE1 pin.
 ...
 * |[1]     |LVDBRKEN  |Low Voltage Interrupt Flag Detection Trigger PWM Brake Function Enable Bit
 * |        |          |0 = Brake Function triggered by LVD interrupt flag event Disabled.
 * |        |          |1 = Brake Function triggered by LVD interrupt flag event Enabled.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |BRKEIEN   |PWM Edge-detect Brake Interrupt Enable Bit
 * |        |          |0 = PWM edge-detect brake interrupt Disabled.
 * |        |          |1 = PWM edge-detect brake interrupt Enabled.
 * |[8]     |BRKLIEN   |PWM Level-detect Brake Interrupt Enable Bit
 ...
 * |        |          |Note 1: If CMP equal to PERIOD, there is no CMPUIF flag in up count type and up-down count type.
 * |        |          |Note 2: This bit is cleared by writing 1 to it.
 ...
 * |        |          |Note 1: If CMP equal to PERIOD, there is no CMPDIF flag in down count type.
 * |        |          |Note 2: This bit is cleared by writing 1 to it.
 ...
 * |[10:8]  |SYNCSRC   |PWM Synchronous Counter Start/Clear Source Select
 * |        |          |000 = Counter synchronous start/clear by trigger TIMER0_PWMSTRG STRGEN.
 * |        |          |001 = Counter synchronous start/clear by trigger TIMER2_PWMSTRG STRGEN.
 * |        |          |010 = Counter synchronous start/clear by trigger TIMER4_PWMSTRG STRGEN.
 * |        |          |011 = Counter synchronous start/clear by trigger TIMER6_PWMSTRG STRGEN.
 * |        |          |100 = Counter synchronous start/clear by trigger TIMER8_PWMSTRG STRGEN.
 * |        |          |101 = Counter synchronous start/clear by trigger TIMER10_PWMSTRG STRGEN.
 ...
 * |        |          |Note 2: If TIMER0/1/ PWM counter synchronous source are from TIMER0, TIMER0_PWMSCTL[8] and TIMER1_PWMSCTL[8] should be set 0, and TIMER2/3/ PWM counter synchronous source are from TIMER2, TIME2_PWMSCTL[8] and TIMER3_PWMSCTL[8] should be set 1.
 * @var TIMER_T::PWMSTRG
...
#define TIMER_EXTCTL_ICAPSSEL_Pos        (8)                                               /*!< TIMER_T::EXTCTL: ICAPSSEL Position     */
#define TIMER_EXTCTL_ICAPSSEL_Msk        (0x7ul << TIMER_EXTCTL_ICAPSSEL_Pos)              /*!< TIMER_T::EXTCTL: ICAPSSEL Mask         */
...
#define TIMER_EXTCTL_CAPSDIV_Pos         (28)                                              /*!< TIMER_T::EXTCTL: CAPSDIV Position      */
#define TIMER_EXTCTL_CAPSDIV_Msk         (0xful << TIMER_EXTCTL_CAPSDIV_Pos)               /*!< TIMER_T::EXTCTL: CAPSDIV Mask          */
...
#define TIMER_PWMCLKSRC_CLKSRC_Msk       (0xful << TIMER_PWMCLKSRC_CLKSRC_Pos)             /*!< TIMER_T::PWMCLKSRC: CLKSRC Mask        */
...
#define TIMER_PWMBNF_BKPINSRC_Msk        (0x7ul << TIMER_PWMBNF_BKPINSRC_Pos)              /*!< TIMER_T::PWMBNF: BKPINSRC Mask         */
...
#define TIMER_PWMFAILBRK_LVDBRKEN_Pos    (1)                                               /*!< TIMER_T::PWMFAILBRK: LVDBRKEN Position */
#define TIMER_PWMFAILBRK_LVDBRKEN_Msk    (0x1ul << TIMER_PWMFAILBRK_LVDBRKEN_Pos)          /*!< TIMER_T::PWMFAILBRK: LVDBRKEN Mask     */
...
#define TIMER_PWMSCTL_SYNCSRC_Msk        (0x7ul << TIMER_PWMSCTL_SYNCSRC_Pos)              /*!< TIMER_T::PWMSCTL: SYNCSRC Mask         */
