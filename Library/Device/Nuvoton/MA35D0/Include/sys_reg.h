...
typedef struct
{
     ...
     * @var SYS_T::EMAC0MISCR
     * Offset: 0x108  EMAC 0 Miscellaneous Control Register (TZNS)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |RMIIEN    |RMII Mode Enable Bit
     * |        |          |0 = EMAC 0 is in RGMII mode.
     * |        |          |1 = EMAC 0 is in RMII mode.
     ...
     * |        |          |Note: This bit is reserved when EMAC 0 is in RMII mode.
     ...
     * |        |          |1110 = 1.87ns.
     * |        |          |1111 = 2.00ns.
     * |        |          |Note: These bits are reserved when EMAC 0 is in RMII mode.
     ...
     * |        |          |1111 = 2.00ns.
     * |        |          |Note: These bits are reserved when EMAC 0 is in RMII mode.
     * @var SYS_T::EMAC1MISCR
     * Offset: 0x10C  EMAC 1 Miscellaneous Control Register (TZNS)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |RMIIEN    |RMII Mode Enable Bit
     * |        |          |0 = EMAC 1 is in RGMII mode.
     * |        |          |1 = EMAC 1 is in RMII mode.
     * |[1]     |PFRMTXEN  |Pause Frame Transmit Enable Bit
     * |        |          |0 = Pause frame transmit Disabled.
     * |        |          |1 = Pause frame transmit Enabled.
     * |[8]     |TXCLKINV  |Transmit Clock Inverter Enable Bit
     * |        |          |0 = Transmit clock (output) inverter Disabled.
     * |        |          |1 = Transmit clock (output) inverter Enabled.
     * |        |          |Note: This bit is reserved when EMAC 1 is in RMII mode.
     * |[9]     |TXCLKGEN  |Transmit Clock Gating Enable Bit
     * |        |          |0 = Transmit clock (output) gating when entered LPI mode Disabled.
     * |        |          |1 = Transmit clock (output) gating when entered LPI mode Enabled.
     * |        |          |Note: This bit is reserved when EMAC 1 is in RMII mode.
     ...
     * |        |          |1110 = 1.87ns.
     * |        |          |1111 = 2.00ns.
     * |        |          |Note: These bits are reserved when EMAC 1 is in RMII mode.
     * |[23:20] |RXCLKDLY  |Receive Clock Path Delay Control
     * |        |          |0000 = 0.00ns (Default).
     * |        |          |0001 = 0.13ns.
     * |        |          |0010 = 0.27ns.
    ...
    __IO uint32_t EMAC0MISCR;            /*!< [0x0108] EMAC 0 Miscellaneous Control Register (TZNS)                     */
    __IO uint32_t EMAC1MISCR;            /*!< [0x010c] EMAC 1 Miscellaneous Control Register (TZNS)                     */
...
#define SYS_IPRST0_EMAC0RST_Pos          (16)                                              /*!< SYS_T::IPRST0: EMAC0RST Position       */
#define SYS_IPRST0_EMAC0RST_Msk          (0x1ul << SYS_IPRST0_EMAC0RST_Pos)                /*!< SYS_T::IPRST0: EMAC0RST Mask           */

#define SYS_IPRST0_EMAC1RST_Pos          (17)                                              /*!< SYS_T::IPRST0: EMAC1RST Position       */
#define SYS_IPRST0_EMAC1RST_Msk          (0x1ul << SYS_IPRST0_EMAC1RST_Pos)                /*!< SYS_T::IPRST0: EMAC1RST Mask           */
...
#define SYS_EMAC0MISCR_RMIIEN_Pos        (0)                                               /*!< SYS_T::EMAC0MISCR: RMIIEN Position     */
#define SYS_EMAC0MISCR_RMIIEN_Msk        (0x1ul << SYS_EMAC0MISCR_RMIIEN_Pos)              /*!< SYS_T::EMAC0MISCR: RMIIEN Mask         */

#define SYS_EMAC0MISCR_PFRMTXEN_Pos      (1)                                               /*!< SYS_T::EMAC0MISCR: PFRMTXEN Position   */
#define SYS_EMAC0MISCR_PFRMTXEN_Msk      (0x1ul << SYS_EMAC0MISCR_PFRMTXEN_Pos)            /*!< SYS_T::EMAC0MISCR: PFRMTXEN Mask       */

#define SYS_EMAC0MISCR_TXCLKINV_Pos      (8)                                               /*!< SYS_T::EMAC0MISCR: TXCLKINV Position   */
#define SYS_EMAC0MISCR_TXCLKINV_Msk      (0x1ul << SYS_EMAC0MISCR_TXCLKINV_Pos)            /*!< SYS_T::EMAC0MISCR: TXCLKINV Mask       */

#define SYS_EMAC0MISCR_TXCLKGEN_Pos      (9)                                               /*!< SYS_T::EMAC0MISCR: TXCLKGEN Position   */
#define SYS_EMAC0MISCR_TXCLKGEN_Msk      (0x1ul << SYS_EMAC0MISCR_TXCLKGEN_Pos)            /*!< SYS_T::EMAC0MISCR: TXCLKGEN Mask       */

#define SYS_EMAC0MISCR_RXCLKINV_Pos      (12)                                              /*!< SYS_T::EMAC0MISCR: RXCLKINV Position   */
#define SYS_EMAC0MISCR_RXCLKINV_Msk      (0x1ul << SYS_EMAC0MISCR_RXCLKINV_Pos)            /*!< SYS_T::EMAC0MISCR: RXCLKINV Mask       */

#define SYS_EMAC0MISCR_TXCLKDLY_Pos      (16)                                              /*!< SYS_T::EMAC0MISCR: TXCLKDLY Position   */
#define SYS_EMAC0MISCR_TXCLKDLY_Msk      (0xful << SYS_EMAC0MISCR_TXCLKDLY_Pos)            /*!< SYS_T::EMAC0MISCR: TXCLKDLY Mask       */

#define SYS_EMAC0MISCR_RXCLKDLY_Pos      (20)                                              /*!< SYS_T::EMAC0MISCR: RXCLKDLY Position   */
#define SYS_EMAC0MISCR_RXCLKDLY_Msk      (0xful << SYS_EMAC0MISCR_RXCLKDLY_Pos)            /*!< SYS_T::EMAC0MISCR: RXCLKDLY Mask       */

#define SYS_EMAC1MISCR_RMIIEN_Pos        (0)                                               /*!< SYS_T::EMAC1MISCR: RMIIEN Position     */
#define SYS_EMAC1MISCR_RMIIEN_Msk        (0x1ul << SYS_EMAC1MISCR_RMIIEN_Pos)              /*!< SYS_T::EMAC1MISCR: RMIIEN Mask         */

#define SYS_EMAC1MISCR_PFRMTXEN_Pos      (1)                                               /*!< SYS_T::EMAC1MISCR: PFRMTXEN Position   */
#define SYS_EMAC1MISCR_PFRMTXEN_Msk      (0x1ul << SYS_EMAC1MISCR_PFRMTXEN_Pos)            /*!< SYS_T::EMAC1MISCR: PFRMTXEN Mask       */

#define SYS_EMAC1MISCR_TXCLKINV_Pos      (8)                                               /*!< SYS_T::EMAC1MISCR: TXCLKINV Position   */
#define SYS_EMAC1MISCR_TXCLKINV_Msk      (0x1ul << SYS_EMAC1MISCR_TXCLKINV_Pos)            /*!< SYS_T::EMAC1MISCR: TXCLKINV Mask       */

#define SYS_EMAC1MISCR_TXCLKGEN_Pos      (9)                                               /*!< SYS_T::EMAC1MISCR: TXCLKGEN Position   */
#define SYS_EMAC1MISCR_TXCLKGEN_Msk      (0x1ul << SYS_EMAC1MISCR_TXCLKGEN_Pos)            /*!< SYS_T::EMAC1MISCR: TXCLKGEN Mask       */

#define SYS_EMAC1MISCR_RXCLKINV_Pos      (12)                                              /*!< SYS_T::EMAC1MISCR: RXCLKINV Position   */
#define SYS_EMAC1MISCR_RXCLKINV_Msk      (0x1ul << SYS_EMAC1MISCR_RXCLKINV_Pos)            /*!< SYS_T::EMAC1MISCR: RXCLKINV Mask       */

#define SYS_EMAC1MISCR_TXCLKDLY_Pos      (16)                                              /*!< SYS_T::EMAC1MISCR: TXCLKDLY Position   */
#define SYS_EMAC1MISCR_TXCLKDLY_Msk      (0xful << SYS_EMAC1MISCR_TXCLKDLY_Pos)            /*!< SYS_T::EMAC1MISCR: TXCLKDLY Mask       */

#define SYS_EMAC1MISCR_RXCLKDLY_Pos      (20)                                              /*!< SYS_T::EMAC1MISCR: RXCLKDLY Position   */
#define SYS_EMAC1MISCR_RXCLKDLY_Msk      (0xful << SYS_EMAC1MISCR_RXCLKDLY_Pos)            /*!< SYS_T::EMAC1MISCR: RXCLKDLY Mask       */
