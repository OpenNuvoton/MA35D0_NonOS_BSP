...
static struct ks_keys  _my_keys_mem[KS_SRAM_KEY_CNT];
static struct ks_keys  *_my_keys;

static int key_size_list[] = { 128, 128, 128, 256, 256, 128, 163, 192, 224, 233, 255,
                               256, 283, 384, 409, 512, 521, 571, 1024, 2048, 4096 };
static int key_size_meta[] = { KS_META_128, KS_META_128, KS_META_128, KS_META_256, KS_META_256,
...
int32_t main_tsi(void)
{
    ...
    while (1)
    {
        sysprintf("\n");
        sysprintf("+---------------------------------------------------------------+\n");
        sysprintf("|  MA35D0 TSI Key Store SRAM operation menu                     |\n");
        sysprintf("+---------------------------------------------------------------+\n");
