/**************************************************************************//**
 * @file     main.c
 * @brief    This sample program decodes a JPEG image with MA35D0 VC8000
 *           JPEG decoder. It enables VC8000 PP which directly output images
 *           to display memory.
 *
...
extern uint32_t  VectorDataBase_JPEG, VectorDataLimit_JPEG;
...
int32_t main(void)
{
	...
	sysprintf("\n\n");
	sysprintf("+--------------------------------------------+\n");
	sysprintf("|  MA35D0 VC8000 decode JPEG bit stream      |\n");
	sysprintf("+--------------------------------------------+\n");
	...
	file_ptr = nc_ptr(&VectorDataBase_JPEG);
	file_size = ptr_to_u32(&VectorDataLimit_JPEG) - ptr_to_u32(&VectorDataBase_JPEG);
