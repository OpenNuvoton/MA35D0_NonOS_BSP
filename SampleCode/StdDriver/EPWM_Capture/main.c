...
void SYS_Init(void)
{
    ...
    /* Set PG multi-function pins for EPWM1 Channel 0 and 2 */
...
int32_t main(void)
{
    ...
    sysprintf("    EPWM1 channel 2(PG.6) <--> EPWM1 channel 0(PG.4)\n\n");
    sysprintf("Use EPWM1 Channel 2(PG.6) to capture the EPWM1 Channel 0(PG.4) Waveform\n");
