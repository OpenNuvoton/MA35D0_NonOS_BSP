...
void SYS_Init(void)
{
    ...
    SYS->GPE_MFPH &= ~(SYS_GPE_MFPH_PE10MFP_Msk | SYS_GPE_MFPH_PE11MFP_Msk | SYS_GPE_MFPH_PE12MFP_Msk);
    SYS->GPE_MFPH |= SYS_GPE_MFPH_PE10MFP_SPI1_SS0 | SYS_GPE_MFPH_PE11MFP_SPI1_CLK | SYS_GPE_MFPH_PE12MFP_SPI1_MOSI;
}
...
int main(void)
{
    ...
    sysprintf("    SPI0_SS(PL12)   <->   SPI1_SS(PE10)\n");
    sysprintf("    SPI0_CLK(PL13)  <->   SPI1_CLK(PE11)\n");
    sysprintf("    SPI0_MOSI(PL14) <->   SPI1_MOSI(PE12)\n\n");
