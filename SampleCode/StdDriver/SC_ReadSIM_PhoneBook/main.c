...
#define SC_INTF 1  // Smartcard interface 1
...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(SC1_MODULE, CLK_CLKSEL4_SC1SEL_HXT, CLK_CLKDIV1_SC1(6));
    ...
    /* Set MFP for SC1 interface */
    SYS->GPG_MFPL |= SYS_GPG_MFPL_PG4MFP_SC1_CLK |
                     SYS_GPG_MFPL_PG5MFP_SC1_DAT |
                     SYS_GPG_MFPL_PG6MFP_SC1_RST |
                     SYS_GPG_MFPL_PG7MFP_SC1_PWR;
    SYS->GPD_MFPL |= SYS_GPD_MFPL_PD7MFP_SC1_nCD;
...
int main(void)
{
    ...
    SC_Open(SC1, SC_PIN_STATE_IGNORE, SC_PIN_STATE_HIGH);
    ...
    // Some cards take a while to ready after reset
