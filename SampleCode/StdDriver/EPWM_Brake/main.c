...
void SYS_Init(void)
{
    ...
    if (Is_MA35D05K())
    {
    	/* Set multi-function pins for EPWM0 Channel 0,1,2,3 and EPWM1 brake pin 0 */
    	SYS->GPD_MFPL &= ~(SYS_GPD_MFPL_PD6MFP_Msk | SYS_GPD_MFPL_PD7MFP_Msk);
    	SYS->GPD_MFPH &= ~(SYS_GPD_MFPH_PD8MFP_Msk | SYS_GPD_MFPH_PD9MFP_Msk | SYS_GPD_MFPH_PD10MFP_Msk);
    	SYS->GPD_MFPL |= (SYS_GPD_MFPL_PD6MFP_EPWM0_CH0 | SYS_GPD_MFPL_PD7MFP_EPWM0_CH1);
    	SYS->GPD_MFPH |= (SYS_GPD_MFPH_PD8MFP_EPWM0_CH2 | SYS_GPD_MFPH_PD9MFP_EPWM0_CH3 | SYS_GPD_MFPH_PD10MFP_EPWM1_BRAKE0);
    }
    else
    {
