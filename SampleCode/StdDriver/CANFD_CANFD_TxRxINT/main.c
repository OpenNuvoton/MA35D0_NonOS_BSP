...
void CANFD_TestItem(void)
{
    sysprintf("\n");
    sysprintf("+-----------------------------------------------------------+\n");
    sysprintf("|             CAN FD Tx Function Test (Master)              |\n");
    sysprintf("+-----------------------------------------------------------+\n");
    sysprintf("| [1] Standard ID = 0x111           ( Data length  8 bytes )|\n");
    sysprintf("| [2] Standard ID = 0x113           ( Data length 12 bytes )|\n");
    sysprintf("| [3] Standard ID = 0x22F           ( Data length 16 bytes )|\n");
    sysprintf("| [4] Standard ID = 0x333           ( Data length 20 bytes )|\n");
    sysprintf("| [5] Extended ID = 0x221           ( Data length 24 bytes )|\n");
    sysprintf("| [6] Extended ID = 0x227           ( Data length 32 bytes )|\n");
    sysprintf("| [7] Extended ID = 0x3333          ( Data length 48 bytes )|\n");
    sysprintf("| [8] Extended ID = 0x44444         ( Data length 64 bytes )|\n");
...
void CANFD_RxTest(void)
{
    ...
    sysprintf("Start CAN FD bus reception :\n");
...
void CANFD_Init(void)
{
    ...
    sysprintf("+---------------------------------------------------------------+\n");
    sysprintf("|    CAN0_TXD(PN3)                         CAN_TXD(Any board)   |\n");
    sysprintf("|    CAN0_RXD(PN2)                         CAN_RXD(Any board)   |\n");
    sysprintf("|          |-----------| CANBUS  |-----------|                  |\n");
    sysprintf("|  ------> |           |<------->|           |<------           |\n");
    sysprintf("|   CAN0_TX|   CANFD   | CANFD_H |    CANFD  |CAN_TX            |\n");
    sysprintf("|          |Transceiver|         |Transceiver|                  |\n");
    sysprintf("|  <------ |           |<------->|           |------>           |\n");
    sysprintf("|   CAN0_RX|           | CANFD_L |           |CAN_RX            |\n");
    sysprintf("|          |-----------|         |-----------|                  |\n");
    sysprintf("|                                                               |\n");
    sysprintf("+---------------------------------------------------------------+\n\n");
...
void CANFD_TxRxINTTest(void)
{
    ...
    sysprintf("|    The sample code needs two boards. One is master(CAN FD transmitter) and |\n");
