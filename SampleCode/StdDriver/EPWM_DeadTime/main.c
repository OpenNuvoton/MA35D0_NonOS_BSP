...
void SYS_Init(void)
{
    ...
    /* Set PG and PL multi-function pins for EPWM0 Channel 0,1,2,3 */
    ...
    SYS->GPG_MFPL |= (SYS_GPG_MFPL_PG0MFP_EPWM0_CH0 | SYS_GPG_MFPL_PG1MFP_EPWM0_CH3);
...
int main(void)
{
    ...
    sysprintf("    waveform output pin: EPWM0_CH0(PG.0), EPWM0_CH1(PL.15), EPWM0_CH2(PL.14), EPWM0_CH3(PG.1)\n");
