...
void SYS_Init(void)
{
    ...
    if (Is_MA35D05K())
    {
        /* PD6: I2C0_SDA; PD7: I2C0_SCL */
        SYS->GPD_MFPL &= ~(SYS_GPD_MFPL_PD6MFP_Msk | SYS_GPD_MFPL_PD7MFP_Msk);
        SYS->GPD_MFPL |= SYS_GPD_MFPL_PD6MFP_I2C0_SDA | SYS_GPD_MFPL_PD7MFP_I2C0_SCL;
    }
    else
    {
        /* PM8: I2C0_SDA; PM9: I2C0_SCL */
        SYS->GPM_MFPH = (SYS->GPM_MFPH & (~(SYS_GPM_MFPH_PM8MFP_Msk|SYS_GPM_MFPH_PM9MFP_Msk))) |
                         SYS_GPM_MFPH_PM8MFP_I2C0_SDA | SYS_GPM_MFPH_PM9MFP_I2C0_SCL;
    }

    /* PG.11(I2S0_MCLK),PG.12(I2S0_LRCK),PG.13(I2S0_BCLK),PG.14(I2S0_DI), PG.15(I2S0_DO) */
    SYS->GPG_MFPH &= ~(SYS_GPG_MFPH_PG11MFP_Msk | SYS_GPG_MFPH_PG12MFP_Msk | SYS_GPG_MFPH_PG13MFP_Msk |
                       SYS_GPG_MFPH_PG14MFP_Msk | SYS_GPG_MFPH_PG15MFP_Msk);
    SYS->GPG_MFPH |= (SYS_GPG_MFPH_PG11MFP_I2S0_MCLK | SYS_GPG_MFPH_PG12MFP_I2S0_LRCK |
                      SYS_GPG_MFPH_PG13MFP_I2S0_BCLK | SYS_GPG_MFPH_PG14MFP_I2S0_DI | SYS_GPG_MFPH_PG15MFP_I2S0_DO);
}
...
int32_t main (void)
{
    ...
    /* Set PM.6 low to enable phone jack on DEV board. */
    /* PM.6(AUDIO_JKEN : keep output low) */
    SYS->GPM_MFPL = (SYS->GPM_MFPL & ~(SYS_GPM_MFPL_PM6MFP_Msk));
    GPIO_SetMode(PM, BIT6, GPIO_MODE_OUTPUT);
    PM6 = 0;
