...
void IrDA_FunctionTxTest()
{
    ...
    UART_SelectIrDAMode(UART6, 57600, TRUE); // TRUE is TX mode
...
void IrDA_FunctionRxTest()
{
    ...
    UART_SelectIrDAMode(UART6, 57600, FALSE); // FALSE is RX mode
